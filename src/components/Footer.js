...
import ftBg from '../assets/images/ft_02.png'
export default class Footer extends Component {
  render() {
    return (
      <footer style={{backgroundImage:`url(${ftBg})`}}>
        <p className="text text-center">2013-2019 Coinpayments. Inc. All rights Reserved. Wallet Services provided by Hodtech OU licence number FH435</p>
        <div className="footer-div ">
            <div className="container">
                <div className="row">
                    ...
                    <div className = "col-4 col-lg-2">
                        <div className ="footer-link footer-img">
                            <button className="btn btn-footer text-white mb-2">Add your coin</button>
                            <img src={appStoreImg } className=" mb-2 img-fluid"></img>
                            <img src={ggStoreImg} className="mb-2 img-fluid"></img>
                        </div>
                    </div>
                </div>
            </div>
